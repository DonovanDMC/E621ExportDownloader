...
export const EXPORT_NAMES = ["artists", "bulk_update_requests", "pools", "posts", "post_replacements", "post_versions", "tag_aliases", "tag_implications", "tags", "wiki_pages"] as const;
