...
export function parse(record: RawPost, _context: CastingContext): PostData {
    return {
        ...
        bg_color:          record.bg_color === "" ? null : record.bg_color,
        ...
        last_commented_at: record.last_commented_at === "" ? null : new Date(record.last_commented_at),
        last_noted_at:     record.last_noted_at === "" ? null : new Date(record.last_noted_at),
